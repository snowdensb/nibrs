...
#### THE ONLY CHANGE WAS TO ADD THE FOLLOWING LIBRARIES
...
## SAMPLE USE
downloadCDEData("/Users/jimdouglas/CDE", constrainYears="2016", constrainStates="NM", download=TRUE)

GA, HI,MN, MD, MS, NE,NM,
